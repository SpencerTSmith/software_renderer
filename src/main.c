...
static void update(void) {
	...
	camera.direction = vec4_to_vec3(mat4_mul_vec4(&camera_rotation_yaw, vec3_to_vec4(target)));
	camera.direction = vec4_to_vec3(mat4_mul_vec4(&camera_rotation_pitch, vec3_to_vec4(camera.direction)));
